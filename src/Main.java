...
public class Main {
    ...
    public static ChessBoard buildBoard() {
        ...
        board.board[3][1] = new Horse("White");
        board.board[3][2] = new Bishop("White");
        board.board[3][3] = new Queen("White");
        board.board[0][4] = new King("White");
        board.board[3][5] = new Bishop("White");
        board.board[3][6] = new Horse("White");
        ...
        board.board[5][1] = new Horse("Black");
        board.board[5][2] = new Bishop("Black");
        board.board[5][3] = new Queen("Black");
        board.board[7][4] = new King("Black");
        board.board[5][5] = new Bishop("Black");
        board.board[5][6] = new Horse("Black");
